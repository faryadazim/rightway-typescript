...
const AddRole:React.FC<any> = ({pagePermission}) => {
    ...
    useEffect(() => {
      ...
      const fetchDataForEdit = (role_id: any) => {
        setUpdateMode(false)
      ...
      const formSubmit = (data: any) => {
        ...
        fetch(
          URL +
            (updateMode
              ?`api/Roles/${initialValues.role_id}?roleName=${data.role_name}`
              : `api/Roles?InputPageName=${data.role_name}`),
          {
      ...
      const deleteBankName = (role_id: any) => {
        Swal.fire({
          title: "Are you sure?",
