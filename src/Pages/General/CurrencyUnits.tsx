...
const CurrencyUnits:React.FC<any> = ({ pagePermission })=> {
  ...
  const fetchDataForEdit = (currency_unit_id:any) => {
    setUpdateMode(false);
  ...
  const deleteMachineName = (currency_unit_id:any) => {
    Swal.fire({
      title: "Are you sure?",
