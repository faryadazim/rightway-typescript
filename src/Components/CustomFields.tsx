...
import { customStyles } from "./ReactSelectorStyle";
...
export const MyCheckbox: React.FC<any> = ({ children, ...props }) => {
...
export const MyFileUpload: React.FC<any> = ({ label, ...props }) => {
  var required = props.required;
  var setFieldValue = props.setFieldValue;
  var changeFieldValue = props.changeFieldValue;
...
export const MyFilterTextInput: React.FC<any> = ({ label, ...props }) => {
  var required = props.required;
  var setFieldValue = props.setFieldValue;
  var changeFieldValue = props.changeFieldValue;
...
export const MyFilterSelect: React.FC<any> = ({ label, ...props }) => {
    ...
    <div className="field item form-group col-md-6 col-sm-6">
      ...
      <div className="col-md-8 col-sm-8">
        <Select
          ...
          value={choice}
          isSearchable={true}
          onChange={(e: any) => changeFilterFieldValue(props.name, e.value)}
          styles={customStyles}
        />
      </div>
    </div>
...
export const MySimpleSelect: React.FC<any> = ({ label, ...props }) => {
  var changeFilterFieldValue = props.changeFilterFieldValue;
  delete props.changeFilterFieldValue;
  const [choice, setChoice] = useState<any>(props.defaultValue);
  useEffect(() => {
    setChoice(props.defaultValue);
  }, [props.defaultValue]);
  return (
